...
INSERT INTO `txy_admin` VALUES (1,'admin','Admin','075eaec83636846f51c152f29b98a2fd','s4f3','/assets/img/avatar.png','admin@fastadmin.net',0,1517210027,1492186163,1517210027,'2f83df54-64e3-4d16-976e-c55d2f3e63e7','normal');
...
CREATE TABLE `txy_admin_log` (
  ...
  PRIMARY KEY (`id`),
  KEY `name` (`username`)
) ENGINE=InnoDB AUTO_INCREMENT=58 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='管理员日志表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `txy_user` VALUES (1,'wangcailin','aaa','a','1111111111',0,0,0,1513303211,1513303240,1517211430,'12312dsffsdfadfasdfa','normal');
...
-- Dump completed on 2018-01-29 15:43:41
