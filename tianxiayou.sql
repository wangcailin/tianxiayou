...
LOCK TABLES `txy_admin` WRITE;
/*!40000 ALTER TABLE `txy_admin` DISABLE KEYS */;
INSERT INTO `txy_admin` VALUES (1,'admin','Admin','075eaec83636846f51c152f29b98a2fd','s4f3','/assets/img/avatar.png','admin@fastadmin.net',0,1513823512,1492186163,1513823512,'76c2b160-2a7a-4c6c-8df4-af709db925de','normal');
/*!40000 ALTER TABLE `txy_admin` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `txy_admin_log` (
  ...
  PRIMARY KEY (`id`),
  KEY `name` (`username`)
) ENGINE=InnoDB AUTO_INCREMENT=41 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='管理员日志表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `txy_config` WRITE;
/*!40000 ALTER TABLE `txy_config` DISABLE KEYS */;
INSERT INTO `txy_config` VALUES (1,'name','basic','Site name','请填写站点名称','string','天下游','','required',''),(2,'beian','basic','Beian','粤ICP备15054802号-4','string','','','',''),(3,'cdnurl','basic','Cdn url','如果静态资源使用第三方云储存请配置该值','string','','','',''),(4,'version','basic','Version','如果静态资源有变动请重新配置该值','string','1.0.1','','required',''),(5,'timezone','basic','Timezone','','string','Asia/Shanghai','','required',''),(6,'forbiddenip','basic','Forbidden ip','一行一条记录','text','','','',''),(7,'languages','basic','Languages','','array','{\"backend\":\"zh-cn\",\"frontend\":\"zh-cn\"}','','required',''),(8,'fixedpage','basic','Fixed page','请尽量输入左侧菜单栏存在的链接','string','dashboard','','required',''),(9,'categorytype','dictionary','Category type','','array','{\"default\":\"Default\",\"page\":\"Page\",\"article\":\"Article\",\"test\":\"Test\"}','','',''),(10,'configgroup','dictionary','Config group','','array','{\"basic\":\"Basic\",\"email\":\"Email\",\"dictionary\":\"Dictionary\",\"others\":\"Others\"}','','',''),(11,'mail_type','email','Mail type','选择邮件发送方式','select','1','[\"Please select\",\"SMTP\",\"Mail\"]','',''),(12,'mail_smtp_host','email','Mail smtp host','错误的配置发送邮件会导致服务器超时','string','smtp.qq.com','','',''),(13,'mail_smtp_port','email','Mail smtp port','(不加密默认25,SSL默认465,TLS默认587)','string','465','','',''),(14,'mail_smtp_user','email','Mail smtp user','（填写完整用户名）','string','10000','','',''),(15,'mail_smtp_pass','email','Mail smtp password','（填写您的密码）','string','password','','',''),(16,'mail_verify_type','email','Mail vertify type','（SMTP验证方式[推荐SSL]）','select','2','[\"None\",\"TLS\",\"SSL\"]','',''),(17,'mail_from','email','Mail from','','string','10000@qq.com','','',''),(18,'alidayu_key','others','Alidayu Key','阿里大于 Access Key ID','string','LTAIsx04CiNWqwMi',' ','require',''),(19,'alidayu_key_secret','others','Alidayu Key Secret','阿里大于 Access Key Secret','string','cUe0dnIQ8sWffxRSx29lM7P5xuuuXg',' ','require',''),(20,'ali_push_key_id','others','Ali Push Key Id','阿里推送 Key Id','string','3292109',' ','require',''),(21,'ali_push_key_secret','others','Ali Push Key Secret','阿里推送 Key Secret','string','3b2d0047ed00477e712de6df37dd1c55',' ','require',''),(22,'ali_push_key','others','Ali Push Key','阿里推送 APP Key','string','23688665',' ','require','');
/*!40000 ALTER TABLE `txy_config` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `txy_information` (
  ...
  `version` varchar(50) DEFAULT NULL COMMENT '应用版本',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='基础信息获取表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `txy_information` WRITE;
/*!40000 ALTER TABLE `txy_information` DISABLE KEYS */;
INSERT INTO `txy_information` VALUES (1,0,0,'/assets/img/qrcode.png','信息简介','http://www.baidu.com',1,'1.0.0');
/*!40000 ALTER TABLE `txy_information` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `txy_update_pargram` WRITE;
/*!40000 ALTER TABLE `txy_update_pargram` DISABLE KEYS */;
INSERT INTO `txy_update_pargram` VALUES (1,'1.0.0','版本1','更新描述测试',0,'','');
/*!40000 ALTER TABLE `txy_update_pargram` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-12-21 10:54:14
-- MySQL dump 10.13  Distrib 5.6.38, for osx10.13 (x86_64)
--
-- Host: localhost    Database: tianxiayou
-- ------------------------------------------------------
...
LOCK TABLES `txy_admin` WRITE;
/*!40000 ALTER TABLE `txy_admin` DISABLE KEYS */;
INSERT INTO `txy_admin` VALUES (1,'admin','Admin','075eaec83636846f51c152f29b98a2fd','s4f3','/assets/img/avatar.png','admin@fastadmin.net',0,1513953825,1492186163,1513953825,'150114eb-7a0b-45fd-b81f-37761afba802','normal');
/*!40000 ALTER TABLE `txy_admin` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `txy_admin_log` (
  ...
  PRIMARY KEY (`id`),
  KEY `name` (`username`)
) ENGINE=InnoDB AUTO_INCREMENT=53 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='管理员日志表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `txy_update_kernel` (
  ...
  `vercode` varchar(50) DEFAULT NULL COMMENT '服务端版本号',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='内核更新表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `txy_update_kernel` WRITE;
/*!40000 ALTER TABLE `txy_update_kernel` DISABLE KEYS */;
INSERT INTO `txy_update_kernel` VALUES (1,'http://zcb.wx.tindsoft.com/','field(\'id,title,images,description,url,actiontype\')','field(\'id,title,images,description,url,actiontype\')','2');
/*!40000 ALTER TABLE `txy_update_kernel` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `txy_update_pargram` WRITE;
/*!40000 ALTER TABLE `txy_update_pargram` DISABLE KEYS */;
INSERT INTO `txy_update_pargram` VALUES (1,'1.0.0','版本1','更新描述测试',0,'http://zcb.wx.tindsoft.com/','field(\'id,title,images,description,url,actiontype\')');
/*!40000 ALTER TABLE `txy_update_pargram` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-12-23 22:09:34
